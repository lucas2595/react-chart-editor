...
Layouts.forEach(function (Layout) {
  describe("<".concat(Layout.displayName, ">"), function () {
    it("wraps container with fullValue pointing to gd._fullLayout", function () {
      ...
      }), /*#__PURE__*/_react.default.createElement(_containers.PlotlyPanel, null, /*#__PURE__*/_react.default.createElement(Layout, null, /*#__PURE__*/_react.default.createElement(_fields.Numeric, {
        label: "Height",
        step: 10,
        attr: "height"
