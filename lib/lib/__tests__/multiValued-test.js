...
describe('multiValued Numeric', function () {
  it('uses multiValued defaultContainer as default increment value', function () {
    ...
    (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_testUtils.TestEditor, _objectSpread(_objectSpread({}, fixtureProps), {}, {
      beforeUpdateLayout: beforeUpdateLayout,
      plotly: _testUtils.plotly
    }), /*#__PURE__*/_react.default.createElement(AxesNumeric, {
      attr: "range[0]"
