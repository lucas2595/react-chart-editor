...
describe('connectAnnotationToLayout', function () {
  it('sends update to layout.annotation[index]', function () {
    ...
    (0, _testUtils.mount)( /*#__PURE__*/_react.default.createElement(_testUtils.TestEditor, _objectSpread(_objectSpread({}, fixture), {}, {
      beforeUpdateLayout: beforeUpdateLayout
    }), /*#__PURE__*/_react.default.createElement(ConnectedNumeric, {
      annotationIndex: 0,
      label: "Angle",
      attr: "textangle"
