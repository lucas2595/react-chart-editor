...
describe('Plot Connection', function () {
  it('can connect Field directly with full connection pipeline', function () {
    ...
    (0, _testUtils.mount)( /*#__PURE__*/_react.default.createElement(_testUtils.TestEditor, _objectSpread(_objectSpread({}, fixtureProps), {}, {
      beforeUpdateLayout: beforeUpdateLayout
    }), /*#__PURE__*/_react.default.createElement(LayoutAxesNumeric, {
      label: "Min",
      attr: "range[0]"
  ...
  it('can connect to layout when connected within trace context', function () {
    ...
    (0, _testUtils.mount)( /*#__PURE__*/_react.default.createElement(_testUtils.TestEditor, _objectSpread(_objectSpread({}, fixtureProps), {}, {
      beforeUpdateLayout: beforeUpdateLayout
    }), /*#__PURE__*/_react.default.createElement(TraceLayoutNumeric, {
      traceIndexes: [0],
      label: "Width",
      attr: "width"
  ...
  it("can't find correct Container when PlotlySection divides Trace and Layout", function () {
    ...
    var wrapper = (0, _testUtils.mount)( /*#__PURE__*/_react.default.createElement(_testUtils.TestEditor, _objectSpread({}, fixtureProps), /*#__PURE__*/_react.default.createElement(_components.PlotlySection, {
      name: "Canvas"
    }, /*#__PURE__*/_react.default.createElement(DeeplyConnectedNumeric, {
      traceIndexes: [0],
      label: "Width",
      attr: "width"
  ...
  it('can modify plotProps with <Trace><PlotlySection><LayoutComp>', function () {
    ...
    var wrapper = (0, _testUtils.mount)( /*#__PURE__*/_react.default.createElement(_testUtils.TestEditor, _objectSpread({}, fixtureProps), /*#__PURE__*/_react.default.createElement(TracePanel, {
      traceIndexes: [0]
    }, /*#__PURE__*/_react.default.createElement(LayoutSection, {
      name: "Canvas"
    }, /*#__PURE__*/_react.default.createElement(ModifiedNumeric, {
      traceIndexes: [0],
      label: "Width",
      attr: "width"
