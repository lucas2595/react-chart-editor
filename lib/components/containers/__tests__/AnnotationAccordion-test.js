...
describe('<AnnotationAccordion>', function () {
  it('generates annotation PlotlyFolds with name == text', function () {
    ...
    var folds = (0, _testUtils.mount)( /*#__PURE__*/_react.default.createElement(_testUtils.TestEditor, _objectSpread(_objectSpread({}, fixture), {}, {
      onUpdate: jest.fn()
    }), /*#__PURE__*/_react.default.createElement(LayoutPanel, {
      name: "Annotations"
    }, /*#__PURE__*/_react.default.createElement(_.AnnotationAccordion, null, /*#__PURE__*/_react.default.createElement(_fields.Numeric, {
      attr: "textangle"
    }))))).find(_.PlotlyFold);
  ...
  it('can add annotations', function () {
    ...
    var editor = (0, _testUtils.mount)( /*#__PURE__*/_react.default.createElement(_testUtils.TestEditor, _objectSpread(_objectSpread({}, fixture), {}, {
      ...
      name: "Annotations"
    }, /*#__PURE__*/_react.default.createElement(_.AnnotationAccordion, {
      canAdd: true
