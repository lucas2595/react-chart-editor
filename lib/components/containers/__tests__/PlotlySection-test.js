...
describe('PlotlySection', function () {
  it('is visible if it contains any visible children', function () {
    ...
    var wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_testUtils.TestEditor, _extends({
      onUpdate: jest.fn()
    }, _testUtils.fixtures.scatter()), /*#__PURE__*/_react.default.createElement(TraceSection, {
      name: "test-section",
      traceIndexes: [0]
    }, /*#__PURE__*/_react.default.createElement(_fields.Flaglist, {
      attr: "mode",
      options: [{
        label: 'Lines',
        value: 'lines'
  ...
  it('is visible if it contains any non attr children', function () {
    var wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_testUtils.TestEditor, _extends({
      onUpdate: jest.fn()
    }, _testUtils.fixtures.scatter()), /*#__PURE__*/_react.default.createElement(_PlotlySection.default, {
      name: "test-section"
  ...
  it('will hide with Info children when attrs not defined', function () {
    ...
    var wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_testUtils.TestEditor, _extends({
      ...
      attr: "badattr",
      traceIndexes: [0]
    }), /*#__PURE__*/_react.default.createElement(_fields.Info, null, "INFO")))).find(_PlotlySection.default);
