...
describe('TraceSelector', function () {
  ...
  it('sets mode to markers if trace scatter, no data or mode provided', function () {
    var editorProps = _objectSpread(_objectSpread({}, _testUtils.fixtures.scatter({
      data: [{
        mode: null,
        xsrc: null,
        ysrc: null
    ...
    var wrapper = (0, _testUtils.mount)( /*#__PURE__*/_react.default.createElement(_testUtils.TestEditor, _extends({}, editorProps, {
      plotly: _testUtils.plotly
    }), /*#__PURE__*/_react.default.createElement(TraceSection, {
      traceIndexes: [0]
    }, /*#__PURE__*/_react.default.createElement(_TraceSelector.default, {
      attr: "type"
  ...
  it('updates type=scatter mode=lines when type=line', function () {
    ...
    var wrapper = (0, _testUtils.mount)( /*#__PURE__*/_react.default.createElement(_testUtils.TestEditor, editorProps, /*#__PURE__*/_react.default.createElement(TraceSection, {
      traceIndexes: [0]
    }, /*#__PURE__*/_react.default.createElement(_TraceSelector.default, {
      attr: "type"
    })))).find(_TraceSelector.default);
