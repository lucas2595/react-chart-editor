...
function render() {
  ...
  var _overrides$attr = overrides.attr,
      ...
      props = _objectWithoutProperties(overrides, _excluded);
  ...
  return (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_testUtils.TestEditor, _extends({}, editorProps, {
...
describe('DataSelector', function () {
  ...
  it('is invisible when a data src does not exist for trace type', function () {
    ...
    wrapper = render(_objectSpread(_objectSpread({}, _testUtils.fixtures.pie()), {}, {
      attr: 'x'
    })).find(_Dropdown.default);
  ...
  it('uses trace specific label', function () {
    ...
    var wrapper = render({}, /*#__PURE__*/_react.default.createElement(TraceDataSelector, {
      traceIndexes: [0],
      label: {
        pie: 'hodor',
        '*': 'rodoh'
