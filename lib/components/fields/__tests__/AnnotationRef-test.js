...
describe('<AnnotationRef>', function () {
  function render(props) {
    return (0, _testUtils.mount)( /*#__PURE__*/_react.default.createElement(_testUtils.TestEditor, _objectSpread(_objectSpread({
      onUpdate: jest.fn()
    }, props), {}, {
      plotly: _testUtils.plotly
    }), /*#__PURE__*/_react.default.createElement(LayoutAnnoPanel, {
      name: "Layout",
      annotationIndex: 0
    }, /*#__PURE__*/_react.default.createElement(_derived.AnnotationRef, {
      attr: "yref"
    }))));
  }
...
describe('<AnnotationArrowRef>', function () {
  function render(props) {
    return (0, _testUtils.mount)( /*#__PURE__*/_react.default.createElement(_testUtils.TestEditor, _objectSpread(_objectSpread({
      ...
      name: "Layout",
      annotationIndex: 0
    }, /*#__PURE__*/_react.default.createElement(_derived.AnnotationArrowRef, {
      attr: "ayref"
    }))));
  }
